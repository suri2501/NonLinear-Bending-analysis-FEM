...
legendID = [h1(1),...
    ...
    h10(1)];
legendString = {...
    sprintf('FEM-IHSDT (von Karman) - SSSS3'),...
    sprintf('FEM-TSDT (von Karman) - SSSS3'),...
    sprintf('FEM-IHSDT (Green-Lagrange) - SSSS3'),...
    sprintf('FEM-TSDT (Green-Lagrange) - SSSS3'),...
    sprintf('ANSYS - SSSS3'),...
    sprintf('FEM-IHSDT (von Karman) - SSFS3'),...
    sprintf('FEM-TSDT (von Karman) - SSFS3'),...
    sprintf('FEM-IHSDT (Green-Lagrange) - SSFS3'),...
    sprintf('FEM-TSDT (Green-Lagrange) - SSFS3'),...
    sprintf('ANSYS - SSFS3')};
