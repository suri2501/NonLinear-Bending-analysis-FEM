...
legendID = [h10(1),h12(1),h22(1),h1(1),h2(1),h3(1),h4(1)];
legendString = {...
    sprintf('\\bf Linear'),...
    sprintf('\\bf von Karman'),...
    sprintf('\\bf Green-Lagrange'),...
    sprintf('\\bf $$ (-0^0/0^0/-0^0/0^0) $$ Red'),...
    sprintf('\\bf $$ (-15^0/15^0/-15^0/15^0) $$ Green'),...
    sprintf('\\bf $$ (-30^0/30^0/-30^0/30^0) $$ Blue'),...
    sprintf('\\bf $$ (-45^0/45^0/-45^0/45^0) $$ Brown')
    };
...
icons(10).LineStyle = '-';
icons(11).Marker = 'none';
% First Line, Second Marker

icons(14).LineStyle = 'none';
icons(16).LineStyle = 'none';
icons(18).LineStyle = 'none';
icons(20).LineStyle = 'none';
