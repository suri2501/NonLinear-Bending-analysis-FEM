...
h = 1;
[ar_N,ar_D] = rat(h/Lx);
file = sprintf('Problem_NL_8_5_0_90_90_0');
...
IndexZ = IndexZ/0.1;
h1 = plot(temp_xz(:,2),IndexZ,'-','LineWidth',1.5,'Color',Colors(1,:));
...
IndexZ = IndexZ/0.1;
h2 = plot(temp_xz(:,2),IndexZ,':','LineWidth',2,'Color',Colors(2,:));
set(h2,'Marker','none','MarkerFaceColor','none','MarkerSize',17);

h3 = plot(temp_xz(:,3),IndexZ,':','LineWidth',2,'Color',Colors(3,:));
set(h3,'Marker','none','MarkerFaceColor','none','MarkerSize',17);

h4 = plot(temp_xz(:,4),IndexZ,':','LineWidth',2,'Color',Colors(4,:));
set(h4,'Marker','none','MarkerFaceColor','none','MarkerSize',17);

h5 = plot(temp_xz(:,5),IndexZ,':','LineWidth',2,'Color',Colors(5,:));
...
IndexZ = IndexZ/0.1;
h6 = plot(temp_xz(:,2),IndexZ,':','LineWidth',2,'Color',Colors(2,:));
set(h6,'Marker','.','MarkerFaceColor','none','MarkerSize',17);

h7 = plot(temp_xz(:,3),IndexZ,':','LineWidth',2,'Color',Colors(3,:));
set(h7,'Marker','.','MarkerFaceColor','none','MarkerSize',17);

h8 = plot(temp_xz(:,4),IndexZ,':','LineWidth',2,'Color',Colors(4,:));
set(h8,'Marker','.','MarkerFaceColor','none','MarkerSize',17);

h9 = plot(temp_xz(:,5),IndexZ,':','LineWidth',2,'Color',Colors(5,:));
...
xlabel('\bf $\bf \bar{\bf \tau}_{xz} ( \bf \tau_{xz} h/P_{0} a )$',...
...
annotation(gcf,'arrow',[0.54 0.32],[0.71 0.71],'LineWidth',2);
annotation(gcf,'textbox',[0.24 0.67 0.07 0.06],...
