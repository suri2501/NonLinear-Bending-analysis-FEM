...
h = 3;
[ar_N,ar_D] = rat(h/Lx);
file = sprintf('Problem_NL_1_2_Stress_xx');
...
h3 = plot(Data_xx(:,1),Data_xx(:,2),':','LineWidth',2,'Color',Colors(5,:));
set(h3,'Marker','*','MarkerFaceColor','none','MarkerSize',20);

load(fullfile(pwd,'plots','Poblem_NL_1_vonKarman_UDL_h_a_1_100_TSDT.mat'));
h4 = plot(Data_xx(:,1),Data_xx(:,2),':','LineWidth',2,'Color',Colors(7,:));
set(h4,'Marker','^','MarkerFaceColor','none','MarkerSize',20);

load(fullfile(pwd,'plots','Poblem_NL_1_Green_UDL_h_a_1_100_IHSDT.mat'));
h5 = plot(Data_xx(:,1),Data_xx(:,2),':','linewidth',1.8,'Color',Colors(2,:));
set(h5,'Marker','s','MarkerFaceColor','none','MarkerSize',22);

load(fullfile(pwd,'plots','Poblem_NL_1_Green_UDL_h_a_1_100_TSDT.mat'));
h6 = plot(Data_xx(:,1),Data_xx(:,2),':','linewidth',1.5,'Color',Colors(15,:));
set(h6,'Marker','.','MarkerFaceColor','none','MarkerSize',15);

load(fullfile(pwd,'plots','Poblem_NL_1_Linear_SSL_h_a_1_100_IHSDT.mat'));
h7 = plot(Data_xx(:,1),Data_xx(:,2),'--','LineWidth',3,'Color',Colors(1,:));
set(h7,'Marker','none','MarkerFaceColor','none','MarkerSize',15);

load(fullfile(pwd,'plots','Poblem_NL_1_Linear_SSL_h_a_1_100_TSDT.mat'));
h8 = plot(Data_xx(:,1),Data_xx(:,2),':','LineWidth',4,'Color',Colors(3,:));
set(h8,'Marker','none','MarkerFaceColor','none','MarkerSize',15);

load(fullfile(pwd,'plots','Poblem_NL_1_vonKarman_SSL_h_a_1_100_IHSDT.mat'));
h9 = plot(Data_xx(:,1),Data_xx(:,2),'--','LineWidth',2,'Color',Colors(5,:));
set(h9,'Marker','*','MarkerFaceColor','none','MarkerSize',20);

load(fullfile(pwd,'plots','Poblem_NL_1_vonKarman_SSL_h_a_1_100_TSDT.mat'));
h10 = plot(Data_xx(:,1),Data_xx(:,2),'--','LineWidth',2,'Color',Colors(7,:));
set(h10,'Marker','^','MarkerFaceColor','none','MarkerSize',20);

load(fullfile(pwd,'plots','Poblem_NL_1_Green_SSL_h_a_1_100_IHSDT.mat'));
h11 = plot(Data_xx(:,1),Data_xx(:,2),'--','linewidth',1.8,'Color',Colors(2,:));
set(h11,'Marker','s','MarkerFaceColor','none','MarkerSize',22);

load(fullfile(pwd,'plots','Poblem_NL_1_Green_SSL_h_a_1_100_TSDT.mat'));
h12 = plot(Data_xx(:,1),Data_xx(:,2),'--','linewidth',1.5,'Color',Colors(15,:));
...
legendID = [h1(1),h2(1),h3(1),h4(1),h5(1),h6(1),h7(1),h8(1),h9(1),h10(1),h11(1),h12(1)];
legendString = {sprintf('FEM-IHSDT (Linear) - UDL'),sprintf('FEM-TSDT (Linear) - UDL'),...
    ...
    sprintf('FEM-IHSDT (Linear) - SSL'),sprintf('FEM-TSDT (Linear) - SSL'),...
