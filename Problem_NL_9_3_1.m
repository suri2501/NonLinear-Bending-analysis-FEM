...
for ii = 1:length(iAngle)
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_Linear_UDL_h_a_1_10_IHSDT_SSSS1_AS_%g.mat',iAngle(ii))));
    AsLinearIHSDT = [AsLinearIHSDT; Data_W(:,2)';];
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_vonKarman_UDL_h_a_1_10_IHSDT_SSSS1_AS_%g.mat',iAngle(ii))));
    AsvonKarmanIHSDT = [AsvonKarmanIHSDT; Data_W(:,2)';];
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_Green_UDL_h_a_1_10_IHSDT_SSSS1_AS_%g.mat',iAngle(ii))));
    AsGreenIHSDT = [AsGreenIHSDT; Data_W(:,2)';];
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_Linear_UDL_h_a_1_10_IHSDT_SSSS1_S_%g.mat',iAngle(ii))));
    SLinearIHSDT = [SLinearIHSDT; Data_W(:,2)';];
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_vonKarman_UDL_h_a_1_10_IHSDT_SSSS1_S_%g.mat',iAngle(ii))));
    SvonKarmanIHSDT = [SvonKarmanIHSDT; Data_W(:,2)';];
    load(fullfile(pwd,'Problem9_3',sprintf('Poblem_NL_9_3_Green_UDL_h_a_1_10_IHSDT_SSSS1_S_%g.mat',iAngle(ii))));
